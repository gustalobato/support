...
//    var layoutImgPath = 'metronic/admin/layout/img/';
...
//            $('#style_color').attr("href", "metronic/admin/layout/css/themes/" + color_ + ".css");
//            if (color == 'light2') {
//                $('.page-logo img').attr('src', 'metronic/admin/layout/img/logo-invert.png');
//            } else {
//                $('.page-logo img').attr('src', 'metronic/admin/layout/img/logo.png');
//            }
//            if ($.cookie) {                
...
//    }
    ...
    // Modificado para não armazenar todas as funções na memória
    // As ações necessárias são realizadas de uma só vez ao ser chamada a função Layout.init()
    return {
        ...
        init: function () {
            ...
            jQuery('.page-sidebar').on('click', 'li > a', function (e) {
                if ($(this).next().hasClass('sub-menu') == false) {
                    if ($('.btn-navbar').hasClass('collapsed') == false) {
                        $('.btn-navbar').click();
                        $('.menu-toggler').click(); // ISG - ADICIONADO PARA FECHAR O MENU SUPERIOR AO CLICAR NO ITEM DESEJADO
                    }
                    return;
                }
...
//            });
            ...
            jQuery('table.table thead tr').addClass('heading');
        }
